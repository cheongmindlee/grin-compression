...
public class HuffmanTree {
    ...
    public HuffmanTree(Map<Short, Integer> freqs) {
        ...
        // Build the tree by combining the first two elements in the queue until it
    ...
    /**
     * Go through the entire binary coded Huffman tree and recursivly recover the
    ...
    public Node readTree(BitInputStream in) {
        ...
        // If bit == 1 return the node and the value associated with it else keep
